...
//Repositoy "Veri tabanına erişim için yazdığımız sınıf" demektir. Repository sınıfı, veritabanındaki tablolarla etkileşim kurmamızı sağlar. Bu sınıfın içinde CRUD (Create, Read, Update, Delete) işlemlerini gerçekleştiren metotlar bulunur.
